"""Regression checks for the summit-sec-token-lens casebook."""
...
from casebook.harness import assert_expected, summit_sec_token_lens_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(summit_sec_token_lens_summary(), assert_expected())
